...
class bwDB:
    def __init__(self, **kwargs):
        ...
        #constructor method, table is for CRUD methods
    ...
    def sql_do(self, sql, params = ()):
        ...
        #method for non-select queries, sql is sting containing SQL
        #params is list containing parameters, returns nothing
    ...
    def sql_query_row(self, sql, params = ()):
        ...
        #query for a single row, sql is a string containing row
    ...
    def sql_query_value(self, sql, params = ()):
        ...
        #query for a single row, sql is a string containing parameters
    ...
    def insert(self, rec):
        ...
        #a list of values ordered by k
        values = [rec[v] for v in klist]
        q = 'INSERT INTO {} ({}) VALUES({})'.format(self.table,
                                                    ', '.join(klist),
    ...
    def update(self, id, rec):
        ...
        #rec is a dict with key/value pairs corresponding to table schema
        klist = sorted (rec.keys())
        #a list of values ordered by key
        values = [rec[v] for v in klist]
        #don't update id
